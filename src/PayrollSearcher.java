...
public class PayrollSearcher {
    ...
    public  List<Employee> findEmployeesByID(String transid) {
        List<Employee> matches = new ArrayList<>();
        String nextid = "";

        for ( Employee next : this.employees ) {
            nextid = next.getId();
            if ( nextid.equals(transid) ) {
                matches.add(next);
            }
        }
    ...
    public List<Job> findJobsByID(String id){
        List<Employee> emp = findEmployeesByID(id);
        List<Job> r = new ArrayList();
    ...
    public List<Employee> findEmployeesByName(String fn, String ln){
        List<Employee> matches = new ArrayList<>();
        String nextname = fn + " " + ln;

        String nextn = "";

        for ( Employee next : this.employees ) {
            nextn = next.getFullName();
            if ( nextn.equals(nextname) ) {
                matches.add(next);
            }
        }
    ...
    public List<Job> findJobsByName(String fn, String ln){
        List<Employee> emp = findEmployeesByName(fn,ln);
        List<Job> r = new ArrayList();
